...
from .models import SupportReplyMensagens, SupportMensagens, Backlogs
...
class BacklogsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'num_versao': forms.NumberInput(attrs={
                'step': '0.1',
                'placeholder': 'Ex: 1.1',
                'style': base_style
            }),

            'data_alteracao': forms.DateTimeInput(attrs={
                'type': 'datetime-local',
                'style': base_style
            }),
            ...
            'dev_responsavel': forms.TextInput(attrs={
